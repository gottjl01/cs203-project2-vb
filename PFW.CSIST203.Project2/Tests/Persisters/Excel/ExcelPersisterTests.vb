...
Namespace PFW.CSIST203.Project2.Tests.Persisters.Excel
    ...
    Public MustInherit Class ExcelDataPersisterTests
        ...
        Public Class _Constructor
            ...
            Public Sub ParameterlessConstructor()
                Dim obj As PFW.CSIST203.Project2.Persisters.Excel.ExcelPersister
                AssertDelegateSuccess(Sub() obj = New Project2.Persisters.Excel.ExcelPersister(),
            ...
            Public Sub ExcelFiledoesNotExist()
                ...
                Dim obj As PFW.CSIST203.Project2.Persisters.Excel.ExcelPersister
                AssertDelegateFailure(Sub() obj = New Project2.Persisters.Excel.ExcelPersister(tmpExcelFile),
            ...
            Public Sub ExcelFileWasReadCorrectly()
                ...
                CopyEmbeddedResourceBaseToDirectory("PFW.CSIST203.Project2.Tests.Resources.Persisters.Excel.ExcelFileWasReadCorrectly", directory)
                ...
                Dim obj As PFW.CSIST203.Project2.Persisters.Excel.ExcelPersister
                AssertDelegateSuccess(Sub() obj = New Project2.Persisters.Excel.ExcelPersister(tmpExcelFile),
        ...
        Public Class GetRowsMethod
            ...
            Public Sub ReturnsNullForNonExistentRow()
                ...
                CopyEmbeddedResourceBaseToDirectory("PFW.CSIST203.Project2.Tests.Resources.Persisters.Excel.ReturnsNullForNonExistentRow", directory)
                Assert.IsTrue(System.IO.File.Exists(tmpExcelFile), "The sample excel data was not properly extracted from the executing assembly")
            ...
            Public Sub RetrievesCorrectRow()
                ...
                CopyEmbeddedResourceBaseToDirectory("PFW.CSIST203.Project2.Tests.Resources.Persisters.Excel.RetrievesCorrectRow", directory)
                Assert.IsTrue(System.IO.File.Exists(tmpExcelFile), "The sample excel data was not properly extracted from the executing assembly")
        ...
        Public Class CountRowsMethod
            ...
            Public Sub ReturnsCorrectCountFromExcelFile()
                ...
                CopyEmbeddedResourceBaseToDirectory("PFW.CSIST203.Project2.Tests.Resources.Persisters.Excel.ReturnsCorrectCountFromExcelFile", directory)
                Assert.IsTrue(System.IO.File.Exists(tmpExcelFile), "The sample excel data was not properly extracted from the executing assembly")
